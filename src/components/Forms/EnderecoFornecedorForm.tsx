...
interface EnderecoFornecedorFormData {
  cep: string;
  logradouro: string;
  numero: string;
  complemento?: string;
...
interface EnderecoFornecedorFormProps {
  ...
  onClose: () => void;
  onSuccess?: () => void;
  enderecoToEdit?: EnderecoFornecedor | null; // Endereço para edição
}

const EnderecoFornecedorForm: React.FC<EnderecoFornecedorFormProps> = ({ 
  fornecedorId, 
  onClose, 
  onSuccess,
  enderecoToEdit = null
  ...
  const onSubmit = async (data: EnderecoFornecedorFormData) => {
    ...
    try {
      ...
      if (enderecoToEdit) {
        ...
        await enderecoFornecedorService.updateEndereco(fornecedorId, enderecoToEdit.id, enderecoData);
      } else {
        // Criar novo endereço
        await enderecoFornecedorService.createEndereco(fornecedorId, enderecoData);
      }
